...
RSpec.describe AttachmentsController, type: :controller do
  ...
  describe 'DELETE #destroy' do
    it 'deletes the attachment of the question' do
      expect { delete :destroy, id: f_attachment, format: :js }.to change(f_question.attachments, :count).by(-1)
    end
    ...
    it 'not deletes the files of the other user' do
      expect { delete :destroy, id: f2_attachment, format: :js }.to_not change(f_question.attachments, :count)
    end
